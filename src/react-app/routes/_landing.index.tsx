            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              <div className="space-y-3 md:space-y-4 text-sm md:text-base text-muted-foreground">
                <p>
                  ...
                  via the <code className="text-xs md:text-sm bg-muted px-1.5 py-0.5 rounded">navigator.modelContext</code> web standard.
                ...
                <p>
                  ...
                  Input schemas use JSON Schema by default — Zod schemas are also supported as an optional convenience.
                </p>
              </div>
